...
En cuanto al modelo de negocio, ofrecemos un sistema de suscripciones que permite a nuestros clientes destacar su trabajo en nuestra interfaz. La aplicación actúa como intermediario entre el cliente y la empresa de remodelación, brindando opciones como la selección del tipo de remodelación deseada, la aprobación o desaprobación de un prototipo de proyecto proporcionado por la empresa y el seguimiento del estado del servicio.
...
#### - **What?**
  La remodelación de casas es uno de los servicios más solicitados por la industria de los bienes raíces, así como por inmobiliarias y particulares. En Perú, el sector de la construcción ha mostrado un gran dinamismo desde 2002 hasta la actualidad, con una tasa de crecimiento promedio del 5.9%. Las construcciones y ampliaciones son los principales proyectos. El 53% de los hogares vive en su propia casa, y el 20% planea adquirir otra propiedad en 2019. Es crucial dejar que los profesionales se encarguen de los cambios en la casa, ya que la construcción de viviendas requiere una especialización importante. Debes estar seguro de que estás contratando a buenos profesionales, como un arquitecto que redacte un proyecto con los planos de la obra y que controle los trabajos del constructor durante la construcción.
  
#### - **Who?**
  Hemos identificado a un sector de empresas que enfrentan dificultades para expandir su base de clientes, ya que aún operan de manera tradicional, utilizando métodos como las llamadas telefónicas, y no cuentan con una aplicación móvil propia.

#### - **Why?**
  Actualmente, sabemos que el servicio de remodelación de casas es demandado a nivel mundial, con clientes dispuestos a invertir en la mejora de propiedades, ya sea para particulares o empresas dedicadas a bienes raíces.

#### - **Where?**
  Nuestro problema a resolver no se limita a nuestro país, sino que afecta a nivel global, ya que muchas empresas y empresarios aún no están dispuestos a invertir en una aplicación móvil para sus negocios y continúan utilizando métodos tradicionales u otras plataformas que no alcanzan a sus clientes ideales.

#### - **When?**
  El problema que buscamos abordar es recurrente cuando los empresarios intentan ampliar su base de clientes. Esto sucede porque muchas personas no tienen el conocimiento adecuado sobre tecnología o desconocen las plataformas adecuadas para potenciar sus negocios.

#### - **How?**
  La entrega puntual del trabajo y la calidad son factores críticos en este problema. Los clientes son exigentes con los acabados y los plazos de entrega, lo que puede dar lugar a imprevistos o retrasos no planificados. Esto a menudo resulta en clientes insatisfechos con el servicio. Para resolver esto, buscamos ofrecer una solución que permita a las empresas llegar a más usuarios y ofrezca a los clientes más opciones al adquirir servicios de remodelación, a través de una aplicación móvil en línea. Además, consideramos la implementación de un "Sistema de Luces" para el ahorro de tiempo y energía, así como un "Autocompletado de la propuesta para las Empresas con Inteligencia Artificial" para ahorrar tiempo en la generación de propuestas.
...
Existe una dificultad de que de las empresas de remodelación de inmuebles tenga un mayor alcance para incrementar el número de sus clientes, debido a una gran variedad de aplicaciones no específicas para este sector. En una investigación de la revista Expansión, en el 2017, indicó que ocho de cada diez usuarios utilizan las redes sociales para buscar trabajo.
...
| :--------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| Las personas tienden a tener dificultades a la hora de buscar un servicio de remodelación, por ello, existe una baja tasa de búsqueda exhaustiva para encontrar ofertas de servicios de remodelación. ¿Cómo podríamos mejorar el proceso de búsqueda de este servicio en corto tiempo?|
Un seguimiento del estado del trabajo solicitado, así también como una sección inicial en la que el usuario podrá visualizar los prototipos de remodelación que le brindarán nuestros clientes para ser aprobados o no antes de realizarse. 
Tener un mejor manejo de los gastos y ganancias obtenidas, esto mejorando el plan de la suscripción hacia la máxima, pues al tenerla, se le mostrará un gráfico señalándolos por cada servicio realizado. |  
Aumento en la cantidad de usuarios suscritos en la aplicación
Creación un espacio de confianza y preferencia hacia el usuario que requiera un servicio de remodelación
Aumento de utilidad de la aplicación|
